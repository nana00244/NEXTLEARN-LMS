              ...
              <tr key={s.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                ...
                <td className="px-6 py-4 text-right">
                  <Link 
                    ...
                    className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 rounded-lg text-xs font-bold hover:bg-indigo-600 hover:text-white transition-all"
                  >
                    Grade
                  </Link>
                </td>
